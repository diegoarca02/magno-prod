...
@Component({
  selector: 'app-productos-cobranza-kpi',
  templateUrl: './productos-cobranza-kpi.component.html',
  styleUrls: ['./productos-cobranza-kpi.component.css']
})
export class ProductosCobranzaKpiComponent implements OnInit {
  ...
  init_data(){
    this.load_btn = true;
    this._kpiService.get_pagos_productos(this.inicio,this.hasta,this.token).subscribe(
        response=>{
              ...
              for(var item of response.data){
                ...
                for(var sem of item.sem_uno){
                  for(var pago of item.pagos){
                      if(sem._id.toString() == pago.producto._id.toString()){
